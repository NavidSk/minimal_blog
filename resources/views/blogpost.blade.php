        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                <div class="bg-white flex flex-col justify-start p-6">
                    <a href="#" class="text-blue-700 text-sm font-bold uppercase pb-4">{{$allPost->categories}}</a>
                    <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">{{$allPost->post_title}}</a>
                    <p href="#" class="text-sm pb-8">
                        By <a href="#" class="font-semibold hover:text-gray-800">{{$allPost->post_author}}</a>, Published on April 25th, 2020
                    </p>
                    <h1 class="text-2xl font-bold pb-3">Introduction</h1>
                    <p class="pb-3">{{$allPost->post_content}}</p>
                </div>
            </article>
